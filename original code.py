...
scrx = n*100
scry = n*100
background = (225,225,225) #used to clear screen while rendering
...
def layout():
    ...
    for i in range(0,scrx,100):
        for j in range(0,scry,100):
            # pygame.draw.rect(screen,(255,255,255),(j,i,100,100),0)
            pygame.draw.rect(screen,colors[c],(j+2,i+2,96,96),0)
            c+=1
